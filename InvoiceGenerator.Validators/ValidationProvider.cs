...
{
  public class ValidationProvider : IValidatorFactory
  {
  ...
  {
    public CompanyValidator(IRepository<Company> repository)
    {
  ...
  {
    public PaymentValidator(IRepository<Payment> repository)
    {
  ...
  {
    public InvoiceValidator(IRepository<Invoice> repository)
    {
